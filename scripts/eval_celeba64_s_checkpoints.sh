#!/bin/bash
# Batch evaluation script for celeba64_uvit_small_s (sparsity-only) checkpoints
...
NUM_GPUS=6
CHECKPOINT_DIR="/home/sunj11/Documents/U-ViT-fresh/workdir/celeba64_uvit_small_s/default_20260107_090008/ckpts"
RESULTS_DIR="eval_results/celeba64_uvit_small_s/${TIMESTAMP}"
SAMPLES_DIR="eval_samples/celeba64_uvit_small_s/${TIMESTAMP}"
