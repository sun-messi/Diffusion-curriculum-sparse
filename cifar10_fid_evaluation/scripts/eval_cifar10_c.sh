#!/bin/bash
set -e
CONFIG_FILE="configs/cifar10_uvit_small_c.py"
NUM_GPUS=6
TIMESTAMP="20260110_125959"
CHECKPOINT_DIR="/home/sunj11/Documents/U-ViT-fresh/workdir/cifar10_uvit_small_c/default_${TIMESTAMP}/ckpts"
RESULTS_DIR="eval_results/cifar10_uvit_small_c/${TIMESTAMP}"
SAMPLES_DIR="eval_samples/cifar10_uvit_small_c/${TIMESTAMP}"
